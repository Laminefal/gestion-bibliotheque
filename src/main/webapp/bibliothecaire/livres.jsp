        ...
        <div class="row">
            ...
            <nav class="col-md-3 col-lg-2 d-md-block sidebar collapse">
                <div class="position-sticky pt-3">
                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="${pageContext.request.contextPath}/livres">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <div>
                        <h5 class="mb-0">
                            <i class="fas fa-list me-2"></i>Liste des livres
                            <span class="badge bg-secondary ms-2">${livres.size()}</span>
                        </h5>
                    </div>
                    <div>
                        <a href="${pageContext.request.contextPath}/livre-form" class="btn btn-primary">
                            ...
                            <table class="table table-hover mb-0">
                                <thead>
                                    <tr>
                                        ...
                                        <th width="15%">Auteurs</th>
                                        <th width="8%">Année</th>
                                        <th width="12%">Domaine</th>
                                        ...
                                        <c:when test="${empty livres}">
                                            <tr>
                                                <td colspan="10" class="text-center py-4">
                                                    ...
                                                    <a href="${pageContext.request.contextPath}/livre-form" class="btn btn-sm btn-primary">
                                        ...
                                        <c:otherwise>
                                            <c:forEach var="livre" items="${livres}">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span class="badge bg-info">${livre.domaine}</span>
                                                    </td>
                                                    <td>
                                                        <span class="badge bg-warning">${livre.niveauRequis}</span>
                                                    </td>
                                                    <td>
                                                        <small class="text-muted">${livre.isbn}</small>
                                                    </td>
                                                    <td>
                    ...
                    <div class="col-md-4">
                        <div class="stat-card">
                            <div class="card-body text-center">
                                ...
                                <h5>Total Livres</h5>
                                <h3 class="text-primary">${livres.size()}</h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="stat-card">
                            <div class="card-body text-center">
                                ...
                                <h5>Livres Actifs</h5>
                                <h3 class="text-success">${statActifs}</h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="stat-card">
                            <div class="card-body text-center">
                                ...
                                <h5>Exemplaires</h5>
                                <h3 class="text-info">${statTotalExemplaires}</h3>
                            </div>
                        </div>
                    </div>
                </div>
